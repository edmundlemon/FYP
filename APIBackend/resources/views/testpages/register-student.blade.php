<x-layout>
	<form method="POST" action="/register/student" enctype="multipart/form-data">
		...
		<div class="mb-6">
			...
			<input type="text" class="border border-gray-400 p-2 w-full" name="id" id="id" value="{{old('id')}}" required>
		...
		<div class="mb-6">
			...
			<input type="faculty" class="border border-gray-400 p-2 w-full" name="faculty" id="faculty" value="{{old('faculty')}}" required>
		...
		<div class="mb-6">
			...
			<input type="program" class="border border-gray-400 p-2 w-full" name="program" id="program" value="{{old('program')}}" required>
