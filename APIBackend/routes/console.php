...
use App\Console\Commands\UpdateExpiredConsultationSlots as UpdateExpiredConsultationSlots;
...
Schedule::command(UpdateExpiredConsultationSlots::class)->everyMinute()->runInBackground();
