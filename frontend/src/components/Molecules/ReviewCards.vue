<template>
  <div>
    <div v-if="store.state.role !== 'admin'" class="mt-7 text-center font-bold text-5xl"><h1>Reviews {{ store.state.role === "lecturer" ? "you've received so far" : " you've made so far" }}</h1></div>
