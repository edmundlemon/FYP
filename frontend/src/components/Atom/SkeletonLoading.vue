<template>
  <div class="h-full w-[98%]">
    ...
    >
      ...
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-7/12 mb-2.5"></div>
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-10/12 mb-2.5"></div>

      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-10/12 mt-10 mb-2.5"></div>
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-9/12 mb-2.5"></div>
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-7/12 mb-2.5"></div>
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-10/12 mb-2.5"></div>
      ...
      <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-10/12"></div>
