<template>
  ...
  <div class="flex justify-center">
    <div class="flex flex-col w-10/12">
      <div class="bg-white w-full py-5 rounded my-3" style="border: 1px solid green">
        <h1 class="font-bold text-4xl pl-6 pb-6">Welcome to Dashboard</h1>
        <div class="flex-row flex ml-6">
			<div>
				<img class="rounded-full" :src="user.photo" alt="user photo">
			</div>
          <div class="flex flex-col justify-center gap-1">
            <h2 class="font-bold text-2xl pl-3">Username: {{ user.name }}</h2>
