    ...
    <div class="container flex justify-center items-center">
      ...
      <div class="flex justify-center w-11/12">
          ...
          <div class="bg-white w-full py-5 rounded my-3 shadow-md">
            ...
            <div class="flex-row flex ml-6">
              ...
              <div class="flex flex-col justify-center gap-1">
                ...
                <h2 v-if="store.state.role == 'lecturer'" class="font-bold text-2xl pl-3">
                  Office: <span class="font-normal">{{ user.office }}</span>
                </h2>
              </div>
            </div>
          </div>
          <div class="flex flex-row space-x-3 justify-center items-center w-full">
            <upcoming-slot class="bg-white shadow-md rounded flex-1 w-1/3 pb-5" />
            <approved-slot class="bg-white shadow-md rounded flex-1 w-1/3 pb-5" @edit-slot="setRescheduleSlot" />
        ...
        <div v-if="edit"
          ...
          <RescheduleForm class="border border-gray-600 rounded-xl border-2 fadein-animation"
            style="filter: drop-shadow(0px 4px 10px black)" :booking="rescheduleSlot"
